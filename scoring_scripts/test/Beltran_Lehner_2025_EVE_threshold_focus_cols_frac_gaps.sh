...
#SBATCH --gres=gpu:1
#SBATCH --mem=10G
#SBATCH -o slurm/bl_EVE_%A_%a.out
#SBATCH -e slurm/bl_EVE_%A_%a.err
#SBATCH -J bl_EVE
#SBATCH --array=130,154,157,160,162,164,171,196,206,211,222,223,224,225,268,278,296
#SBATCH --exclude compute-gc-17-213,compute-g-16-255
...
for seed in 1000 2000 3000 4000 5000; do
    python ${script_dir}/train_VAE.py \
        ...
        --MSA_weights_location ${root}/EVCouplings/output/Beltran_Lehner_2025/weights/threshold_focus_cols_frac_gaps \
        --VAE_checkpoint_location ${root}/DMS_EVE_models/threshold_focus_cols_frac_gaps/ \
        --model_parameters_location ${script_dir}/EVE/default_model_params.json \
        --training_logs_location ${root}/DMS_EVE_models/threshold_focus_cols_frac_gaps/logs/ \
...
python ${script_dir}/compute_evol_indices_DMS.py \
    ...
    --output_scores_folder ${root}/model_scores/zero_shot_substitutions/EVE_threshold_focus_cols_frac_gaps/ \
