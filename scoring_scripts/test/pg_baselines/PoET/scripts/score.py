...
import sys
sys.path.append('/n/groups/marks/users/elain/PG2/ProteinGym/proteingym/baselines/PoET/')
sys.path.append('/n/groups/marks/projects/marks_lab_and_oatml/ProteinGym2/envs/PoET/')
