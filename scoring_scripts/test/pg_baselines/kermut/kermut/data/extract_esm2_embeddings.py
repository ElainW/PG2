...
import torch
import sys
sys.path.append("/n/groups/marks/users/elain/PG2/ProteinGym/proteingym/baselines/esm/")
...
def extract_single_embeddings(
    ...
    output_path = Path(output_path, f"{DMS_id}.h5")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--DMS_idx", type=int, required=True)
    parser.add_argument("--DMS_data_folder", type=str, required=True, help="path to the directory with DMS score csv")
    parser.add_argument(
        "--reference_file", type=str, required=True, help="path to the reference file"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--output_path", type=str, required=True, help="Output directory of the embeddings"
    )
    ...
    # Load model
    model_path = Path("/n/groups/marks/projects/marks_lab_and_oatml/ProteinGym/baseline_models/ESM2", "esm2_t33_650M_UR50D.pt")
